...
if __name__ == "__main__":
    ...
    #stringdb files 
    stringdb_file = "data/9606.protein.links.full.v11.5.txt"
    stringdb_aliases_file = "data/9606.protein.aliases.v11.5.txt"

    #translate from stringdb names to gene symbols
    df = translate_from_stringdb(stringdb_file, stringdb_aliases_file)

    # create the hhi from the filtered data frame
    hhi = nx.from_pandas_edgelist(df,
                                  source = "protein1",
                                  target = "protein2",
