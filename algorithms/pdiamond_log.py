...
# ======================================================================================
def pdiamond_log_iteration_of_first_X_nodes(G, S, X, alpha, temperature=1.0, top_k=0, top_p=0):
    """
    Parameters:
    ----------
    - G:     graph
...
#
# ===========================================================================
def pDIAMOnD_log(G_original, seed_genes, max_number_of_added_nodes, alpha, outfile=None, max_num_iterations=10, temperature=1.0, top_k=0, top_p=0.0):
    ...
    for i in range(max_num_iterations):
        ...
        added_nodes = pdiamond_log_iteration_of_first_X_nodes(G_original,
                                                            disease_genes,
...
if __name__ == '__main__':
    ...
    # run Prob DIAMOnD
    added_nodes = pDIAMOnD_log(G_original,
                            seed_genes,
