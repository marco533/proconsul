...
def print_usage():
    ...
    print('                                   They can be: "diamond", "pdiamond", "pdiamond2", "pdiamond_rank", "pdiamond_temp", "pdiamond_topk", "pdiamond_complete", "heat_diffusion"')
...
def parse_args():
    ...
    parser.add_argument('-a','--algs', nargs='+', default=["diamond", "pdiamond", "pdiamond_complete", "heat_diffusion"],
...
def read_terminal_input(args):
    ...
    for alg in algs:
        if alg not in ["diamond", "pdiamond", "pdiamond2", "heat_diffusion"]:
