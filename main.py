...
def print_usage():
    ...
    print('                                   They can be: "diamond", "diamond2, "pdiamond", "pdiamond2", "heat_diffusion"')
...
def parse_args():
    ...
    parser.add_argument('-a','--algs', nargs='+', default=["diamond", "diamond2", "pdiamond", "pdiamond2", "heat_diffusion"],
...
def read_terminal_input(args):
    ...
    for alg in algs:
        if alg not in ["diamond", "diamond2", "pdiamond", "pdiamond2", "heat_diffusion"]:
